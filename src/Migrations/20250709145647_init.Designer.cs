...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("src.Domain.Entities.WorkspaceEntity.Relationships.UserFolder", b =>
                {
                    b.HasOne("src.Domain.Entities.WorkspaceEntity.PlanFolder", "Folder")
                        .WithMany("Members")
                        .HasForeignKey("FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("src.Domain.Entities.UserEntity.User", "User")
                        .WithMany("Folders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("src.Domain.Entities.WorkspaceEntity.Relationships.UserList", b =>
                {
                    b.HasOne("src.Domain.Entities.WorkspaceEntity.PlanList", "List")
                        .WithMany("Members")
                        .HasForeignKey("ListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("src.Domain.Entities.WorkspaceEntity.Relationships.UserSpace", b =>
                {
                    b.HasOne("src.Domain.Entities.WorkspaceEntity.Space", "Space")
                        .WithMany("Members")
                        .HasForeignKey("SpaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("src.Domain.Entities.WorkspaceEntity.Relationships.UserTask", b =>
                {
                    b.HasOne("src.Domain.Entities.WorkspaceEntity.PlanTask", "Task")
                        .WithMany("Asignees")
            ...
            modelBuilder.Entity("src.Domain.Entities.WorkspaceEntity.Relationships.UserWorkspace", b =>
                {
                    ...
                    b.HasOne("src.Domain.Entities.WorkspaceEntity.Workspace", "Workspace")
                        .WithMany("Members")
