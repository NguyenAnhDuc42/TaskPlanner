...
export function WorkspaceList({
  ...
  return (
    <div className="h-full bg-card flex flex-col border border-border/50 shadow-sm overflow-hidden outline rounded-md ">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative w-72">
            ...
            <input
              ...
              className="w-full h-9 pl-10 pr-9 bg-card border border-border text-foreground placeholder-muted-foreground font-mono text-sm rounded-md focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors"
            />
            {searchQuery && (
              <button
