...
export function SpaceViewRail({ tabOrder, activeTab, onTabChange, onOpenSettings }: Readonly<SpaceViewRailProps>) {
  return (
    // Fixed-width spacer reserves layout space so the content area doesn't shift when the rail
    // expands — the actual rail is absolutely positioned and overlays the content on hover.
