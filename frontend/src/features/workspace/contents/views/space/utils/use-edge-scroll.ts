...
function handleListModeScroll(y: number, rect: DOMRect, el: HTMLElement, baseSpeed: number) {
...
function handleBoardModeScroll(x: number, y: number, rect: DOMRect, el: HTMLElement, baseSpeed: number, threshold: number) {
...
export function useEdgeScroll(
  ...
  useEffect(() => {
    ...
    const checkScroll = () => {
      ...
      if (isListMode) {
        handleListModeScroll(y, rect, el, baseSpeed);
      } else {
        handleBoardModeScroll(x, y, rect, el, baseSpeed, threshold);
      }
