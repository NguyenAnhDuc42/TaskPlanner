  ...
  return (
    <div className="min-h-screen flex bg-background">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-card/20 border-r border-border/20 items-center justify-center p-12">
        <div className="absolute top-1/4 left-1/3 w-72 h-72 rounded-full bg-primary/10 blur-[100px] pointer-events-none" />
        <div className="absolute bottom-1/3 right-1/4 w-56 h-56 rounded-full bg-violet-500/8 blur-[80px] pointer-events-none" />
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div>
            <h1 className="text-2xl font-black text-foreground/95 tracking-tight">Forgot your password?</h1>
