...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260322211303_Some_update_for_task_stuff")]
    partial class Some_update_for_task_stuff
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.ChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.Dashboard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.Status", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.ViewDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.Widget", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.Relationship.EntityAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.Support.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.ChatMessage", b =>
                {
                    b.HasOne("Domain.Entities.ProjectEntities.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
                        .HasForeignKey("ChatRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ProjectEntities.ChatMessage", "ReplyToMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.ProjectEntities.Widget", b =>
                {
                    b.HasOne("Domain.Entities.ProjectEntities.Dashboard", null)
                        .WithMany("Widgets")
                        .HasForeignKey("DashboardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Domain.Entities.ProjectEntities.WidgetLayout", "Layout", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.Relationship.TaskAssignment", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Relationship.WorkspaceMember", null)
                        .WithMany()
