...
public static class UpdateSpaceStatusesEndpoint
{
    public static void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPut("/api/statuses/sync/batch", async (
            [FromBody] UpdateSpaceStatusesCommand request,
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            var result = await dispatcher.SendAsync<UpdateSpaceStatusesCommand, long>(request, cancellationToken);
